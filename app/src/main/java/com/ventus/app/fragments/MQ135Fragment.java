                    ...
                    if (this != null) {
                        getActivity().runOnUiThread(new Runnable() {
                            ...
                            public void run() {
                                ...
                                secondInfoText.setText(differentSize.spannableTwoString("Массовая концентрация", textSize, convert.ppmToMg(myResponse, 44.01),
                                ...
                                thirdInfoText.setText(differentSize.spannableTwoString("Объёмная доля", textSize, convert.ppmToVolumeFraction(myResponse),
                                        textSize * 4, "%", textSize + 10));
                                fourInfoText.setText(differentSize.spannableTwoString("НКПР", textSize, convert.ppmToLowExplosionLevel(myResponse, 0.0),
                                        textSize * 4, "%", textSize + 10));
                            }
                        });
                    }
